...
from PyQt5.QtWidgets import QWidget, QTableWidget, QHBoxLayout, QTableWidgetItem, QApplication, QHeaderView
...
class Table(QWidget):
    ...
    def initUI(self):
        ...
        # TODO 优化 2 设置水平方向表格为自适应的伸缩模式, 横向填充整儿窗口
        ...
        table_widget.setItem(0, 0, newItem)

        newItem = QTableWidgetItem('男')
        table_widget.setItem(0, 1, newItem)

        newItem = QTableWidgetItem('160')
        table_widget.setItem(0, 2, newItem)
